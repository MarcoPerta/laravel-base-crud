...
class ComicController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('comics.show', $comics->id)->with('success', "Hai modificato con successo il fumetto: $comics->title");
    }
    ...
    public function destroy($id)
    {
        $comics = Comic::findOrFail($id);
        $comics->delete();
        return redirect()->route('comics.index')->with('success', "Hai cancellato con successo il fumetto: $comics->title");
    }
}
